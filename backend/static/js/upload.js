...
$("#multiplefileupload").fileinput({
  ...
  dropZoneTitle:
    '<div class="upload-area"><i class="far fa-images"></i><p>Browse or Drag and Drop .docx, .pdf</p> <div> <button type="button">Browse File</button> </div></div>',
  dropZoneClickTitle: "",
  ...
  layoutTemplates: {
    preview:
      ...
      " </div>\n",
    actionDrag:
      '<button type="button" class="file-drag-handle {dragClass}" title="{dragTitle}">{dragIcon}</button>',
    footer:
      '<div class="file-thumbnail-footer">\n' +
